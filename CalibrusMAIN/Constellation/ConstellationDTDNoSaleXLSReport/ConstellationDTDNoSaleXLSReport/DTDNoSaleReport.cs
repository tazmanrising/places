...
namespace ConstellationDTDNoSaleXLSReport
{
    public class DTDNoSaleReport
    {
        ...
        public static void Main(string[] args)
        {
            ...
            List<Vendor> vendorsList = GetVendorList();
        ...
        private static void WriteReportAllNoSales(ref Excel.Application exApp, ref Excel.Range exRange, DateTime sDate, DateTime eDate, Vendor vendor)
        {
            #region Variables
        ...
        private static void WriteReportAllNoSales(ref Excel.Application exApp, ref Excel.Range exRange, DateTime sDate, DateTime eDate, List<Vendor> vendorList)
        {
            #region Variables
            Excel.Font exFont = null;
            //Placeholders as I move through the Excel sheet
        ...
        //Specific Vendor
        private static void WriteReportAllNoSales30DayDetail(ref Excel.Application exApp, ref Excel.Range exRange, DateTime sDate, DateTime eDate, Vendor vendor)
        {
            int rowInitialize = 1; //initial seed for the row data
            int row = 0;// where we start the row data  
            ...
            IList<spNoSaleDTDDetailByVendor_Result> mtdCallDeatilResult = GetNoSalesMTDDetail(sDate, eDate, vendor.VendorNumber);
        ...
        private static void WriteReportAllNoSales30DayDetail(ref Excel.Application exApp, ref Excel.Range exRange, DateTime sDate, DateTime eDate)
        {
            ...
            IList<spNoSaleDTDDetailByVendor_Result> mtdCallDeatilResult = GetNoSalesMTDDetail(sDate, eDate);
        ...
        /// </summary>
        /// <returns></returns>
        private static List<Vendor> GetVendorList()
        {
        ...
        /// <param name="vendorNumber"></param>
        /// <returns></returns>
        private static IList<spNoSaleDTDDetailByVendor_Result> GetNoSalesMTDDetail(DateTime startDate, DateTime endDate, string vendorNumber)
        {
            IList<spNoSaleDTDDetailByVendor_Result> spResult = null;

            try
            {
                using (ConstellationEntities entities = new ConstellationEntities())
                {
                    spResult = entities.spNoSaleDTDDetailByVendor(startDate: startDate, endDate: endDate, vendorNumber: vendorNumber).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        /// <param name="endDate"></param>
        /// <returns></returns>
        private static IList<spNoSaleDTDDetailByVendor_Result> GetNoSalesMTDDetail(DateTime startDate, DateTime endDate)
        {
            IList<spNoSaleDTDDetailByVendor_Result> spResult = null;
            ...
            try
            {
                using (ConstellationEntities entities = new ConstellationEntities())
                {
                    spResult = entities.spNoSaleDTDDetailByVendor(startDate: startDate, endDate: endDate, vendorNumber: null).ToList();
                }
            }
            catch (Exception ex)
            {
        ...
        private static void SaveXlsDocument(ref string reportPath, ref string xlsFilename, ref string xlsFilePath, Excel.Workbook exBook, DateTime currentDate, string vendor)
        {
            ...
            xlsFilename = "CNE Res DTD - No Sale Trending Report - " + vendorType + " - " + String.Format("{0:yyyyMMdd}", currentDate) + ".xlsx";
        ...
        private static void SendEmail(ref string xlsFilePath, DateTime currentDate, string vendor)
        {
            ...
            try
            {
                ...
                mail.Subject = "Constellation DTD " + (vendor == "Total" ? "All Vendors" : "Vendor: " + vendor) + " No Sale Report for " + currentDate.ToString("dddd, dd MMMM yyyy") + ".";
        ...
        private static void SendErrorMessage(Exception ex)
        {
            ...
            Calibrus.ErrorHandler.Alerting alert = new Calibrus.ErrorHandler.Alerting("ConstellationDTDNoSaleXLSReport");
