(function () {
    ...
    function vendorController(portalData, $log, $location, $filter, $modal) {
...
(function () {
    ...
    function vendorLogController(portalData, $log, $modalInstance, vendor) {
        ...
        pop.ok = function (u) {
            ...
            $modalInstance.close({ vendorId: pop.vendor.Id, loggedInUser: u });
        };
