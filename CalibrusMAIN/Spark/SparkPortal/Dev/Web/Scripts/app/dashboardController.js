(function () {
    ...
    var verifiedBarFactory = function (t) {
        return {
            options: {
                chart: {
                    type: 'column'
    ...
    function dashboardController(reportService, userCtx, $log) {
        ...
        */
        ...
        var getVerifiedAccountsToday = function() {
            ...
            reportService.getVerifiedAccountsChartSummary('D', vm.vendorId, vm.officeId).then(function (data) {
                var verifiedSummaryDay = data[0];
                if (verifiedSummaryDay.length === 0) {
                    vm.verifiedAccountsPieChartConfigD.series[0].data = [];
                }
                for (var x = 0; x < verifiedSummaryDay.length; x++) {
                    //$log.info('DAY: ' + JSON.stringify(verifiedSummaryDay[x]));
                    vm.verifiedAccountsPieChartConfigD.series[0].data[x].name = verifiedSummaryDay[x].Disposition;
                    vm.verifiedAccountsPieChartConfigD.series[0].data[x].y = verifiedSummaryDay[x].Accounts;
                    vm.verifiedAccountsPieChartConfigD.series[0].data[x].drilldown = verifiedSummaryDay[x].Disposition;
                    if (verifiedSummaryDay[x].Disposition === 'Verified') {
                        vm.verifiedAccountsPieChartConfigD.series[0].data[x].color = Highcharts.getOptions().colors[2];
                    } else {
                        vm.verifiedAccountsPieChartConfigD.series[0].data[x].color = Highcharts.getOptions().colors[8];
                    }
                }
                //drilldown
                for (var y = 0; y < data[1].length; y++) {
                    //$log.info('DAY DETAIL: ' + JSON.stringify(data[1][y]));
                    vm.verifiedAccountsPieChartConfigD.options.drilldown.series[0].data[y] = { name: data[1][y].Disposition, y: data[1][y].Accounts }
                }

                vm.verifiedAccountsPieChartConfigD.loading = false;
        ...
        var getVerifiedAccountsWeek = function () {
            if (vm.user.userVendorId) {
                vm.vendorId = vm.user.userVendorId;
            }
            if (vm.user.userOfficeId) {
            ...
            reportService.getVerifiedAccountsChartSummary('W', vm.vendorId, vm.officeId).then(function (data) {
                var verifiedSummaryWeek = data[0];
                if (verifiedSummaryWeek.length === 0) {
                    vm.verifiedAccountsPieChartConfigW.series[0].data = [];
                }
                for (var x = 0; x < verifiedSummaryWeek.length; x++) {
                    //$log.info('WEEK: ' + JSON.stringify(vm.verifiedSummaryWeek[x]));
                    vm.verifiedAccountsPieChartConfigW.series[0].data[x].name = verifiedSummaryWeek[x].Disposition;
                    vm.verifiedAccountsPieChartConfigW.series[0].data[x].y = verifiedSummaryWeek[x].Accounts;
                    vm.verifiedAccountsPieChartConfigW.series[0].data[x].drilldown = verifiedSummaryWeek[x].Disposition;
                    if (verifiedSummaryWeek[x].Disposition === 'Verified') {
                        vm.verifiedAccountsPieChartConfigW.series[0].data[x].color = Highcharts.getOptions().colors[2];
                    } else {
                        vm.verifiedAccountsPieChartConfigW.series[0].data[x].color = Highcharts.getOptions().colors[8];
                    }
                }
                //drilldown
                for (var y = 0; y < data[1].length; y++) {
                    //$log.info('WEEK DETAIL: ' + JSON.stringify(data[1][y]));
                    vm.verifiedAccountsPieChartConfigW.options.drilldown.series[0].data[y] = { name: data[1][y].Disposition, y: data[1][y].Accounts }
                }

                vm.verifiedAccountsPieChartConfigW.loading = false;

            }, function (reason) {
                vm.error = "Error getting disposition list";
            });
        }
        var getVerifiedAccountsMonth = function () {
            ...
            reportService.getVerifiedAccountsChartSummary('M', vm.vendorId, vm.officeId).then(function (data) {
                var verifiedSummaryMonth = data[0];
                if (verifiedSummaryMonth.length === 0) {
                    vm.verifiedAccountsPieChartConfigM.series[0].data = [];
                }
                for (var x = 0; x < verifiedSummaryMonth.length; x++) {
                    //$log.info('MONTH: ' + JSON.stringify(verifiedSummaryMonth[x]));
                    vm.verifiedAccountsPieChartConfigM.series[0].data[x].name = verifiedSummaryMonth[x].Disposition;
                    vm.verifiedAccountsPieChartConfigM.series[0].data[x].y = verifiedSummaryMonth[x].Accounts;
                    vm.verifiedAccountsPieChartConfigM.series[0].data[x].drilldown = verifiedSummaryMonth[x].Disposition;
                    if (verifiedSummaryMonth[x].Disposition === 'Verified') {

                        vm.verifiedAccountsPieChartConfigM.series[0].data[x].color = Highcharts.getOptions().colors[2];
                    } else {
                        vm.verifiedAccountsPieChartConfigM.series[0].data[x].color = Highcharts.getOptions().colors[8];
                    }
                }
                //drilldown
                for (var y = 0; y < data[1].length; y++) {
                    //$log.info('MONTH DETAIL: ' + JSON.stringify(data[1][y]));
                    vm.verifiedAccountsPieChartConfigM.options.drilldown.series[0].data[y] = { name: data[1][y].Disposition, y: data[1][y].Accounts }
                }

                vm.verifiedAccountsPieChartConfigM.loading = false;

            }, function (reason) {
                vm.error = "Error getting disposition list";
            });
        }
        var getVerifiedAccountsYear = function () {
            ...
            reportService.getVerifiedAccountsChartSummary('Y', vm.vendorId, vm.officeId).then(function (data) {
                //$log.info('DATA YEAR: ' + JSON.stringify(data));

                var verifiedSummaryYear = data[0];
                if (verifiedSummaryYear.length === 0) {
                    vm.verifiedAccountsPieChartConfigY.series[0].data = [];
                }
                for (var x = 0; x < verifiedSummaryYear.length; x++) {
                    //$log.info('YEAR SUMMARY: ' + JSON.stringify(verifiedSummaryYear[x]));
                    vm.verifiedAccountsPieChartConfigY.series[0].data[x].name = verifiedSummaryYear[x].Disposition;
                    vm.verifiedAccountsPieChartConfigY.series[0].data[x].y = verifiedSummaryYear[x].Accounts;
                    vm.verifiedAccountsPieChartConfigY.series[0].data[x].drilldown = verifiedSummaryYear[x].Disposition;
                    if (verifiedSummaryYear[x].Disposition === 'Verified') {
                        vm.verifiedAccountsPieChartConfigY.series[0].data[x].color = Highcharts.getOptions().colors[2];
                    } else {
                        vm.verifiedAccountsPieChartConfigY.series[0].data[x].color = Highcharts.getOptions().colors[8];
                    }
                }
                //drilldown
                for (var y = 0; y < data[1].length; y++) {
                    //$log.info('YEAR DETAIL: ' + JSON.stringify(data[1][y]));
                    vm.verifiedAccountsPieChartConfigY.options.drilldown.series[0].data[y] = { name: data[1][y].Disposition, y: data[1][y].Accounts }
                }

                vm.verifiedAccountsPieChartConfigY.loading = false;
        ...
        vm.verifiedAccountsPieChartConfigD = new verifiedChartFactory('Verified Accounts Today', 'accounts');
        vm.verifiedAccountsPieChartConfigW = new verifiedChartFactory('Verified Accounts WTD', 'accounts');
        vm.verifiedAccountsPieChartConfigM = new verifiedChartFactory('Verified Accounts MTD', 'accounts');
        vm.verifiedAccountsPieChartConfigY = new verifiedChartFactory('Verified Accounts YTD', 'accounts');

        getVerifiedAccountsToday();
        getVerifiedAccountsWeek();
        getVerifiedAccountsMonth();
        getVerifiedAccountsYear();

        //***************************************************************Top Vendor Bar Graph************************************************************************
        /*
        vm.topVendorsConfig = new verifiedBarFactory("Top Vendors")
        vm.getTopVedors = function (range) {

            //$log.info(JSON.stringify(vm.topVendorsConfig));
            ...
            vm.topVendorsConfig.options.title.text = 'Top Vendors (' + titleRange + ')';
            vm.topVendorsConfig.loading = true;
            ...
            reportService.getTopVendorsChart(range).then(function (data) {

                var topVendors = data;

                if (topVendors.length === 0) {
                    vm.topVendorsConfig.series[0].data = [];
                    vm.topVendorsConfig.series[1].data = [];
                    return;
                }

                //set up object
                vm.topVendorsConfig.xAxis = {};

                //build data
                var categories = [];
                var series = [];
                
                for (var x = 0; x < topVendors.length; x++) {                    

                    //build categories
                    if (categories.indexOf(topVendors[x].VendorName) == -1)
                    {
                        categories.push(topVendors[x].VendorName);
                    }

                    //build series
                    var dispIndex = -1;
                    for (var disp = 0; disp < series.length; disp++) {
                        //$log.info('LOOK FOR: ' + topVendors[x].Disposition);
                        if (series[disp].name == topVendors[x].Disposition) {
                            //$log.info('FOUND: ' + topVendors[x].Disposition + ', INDEX: ' + dispIndex);
                            dispIndex = disp;
                            break;
                        }
                    }
                    ...
                    if (dispIndex == -1) {
                        var s = {
                            name: topVendors[x].Disposition,
                            data: [],
                            color: topVendors[x].Disposition == 'Verified' ? Highcharts.getOptions().colors[2] : Highcharts.getOptions().colors[8]
                        }
                        series.push(s);
                    }                 
                }
                ...
                //$log.info('STARTING DATA LOOP');
                for (var x = 0; x < categories.length; x++) {                    
                    var vendorName = categories[x];
                    //$log.info('VENDOR: ' + vendorName);
                    for (var y = 0; y < series.length; y++) {                        
                        var data = series[y].data;
                        var disposition = series[y].name;
                        //$log.info('SERIES: ' + disposition);
                        for (var z = 0; z < topVendors.length; z++) {
                            var record = topVendors[z];
                            if (record.VendorName == vendorName && record.Disposition == disposition) {
                                series[y].data.push(record.Accounts)
                                //$log.info('ADDED ' + record.Accounts + ' TO ' + disposition + ' FOR ' + vendorName);
                            }
                        }
                    }
                }
                ...
                //set categories
                vm.topVendorsConfig.xAxis.categories = categories;
                $log.info('xAxis.categories: ' + JSON.stringify(vm.topVendorsConfig.xAxis.categories));

                vm.topVendorsConfig.series = series;
                $log.info('xAxis.series: ' + JSON.stringify(vm.topVendorsConfig.series));
                
                vm.topVendorsConfig.loading = false;
