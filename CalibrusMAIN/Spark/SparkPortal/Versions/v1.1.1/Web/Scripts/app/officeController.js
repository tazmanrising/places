(function () {
    ...
    function officeController(portalData, $log, $location, $filter, $modal, $scope) {
...
(function () {
    ...
    function officeLogController(portalData, $log, $modalInstance, office) {
        ...
        pop.ok = function (u) {
            ...
            $modalInstance.close({ officeId: pop.office.Id, loggedInUser: u });
        };
