...
angular.module('calibrus')
  .controller('DataEntryLineItemCtrl', function ($rootScope, $window, $state, $ionicPopup, addressService, googleService, enrollmentService, calibrusSparkRequestService, formValidationService, userCache) {
    var vm = this;
