...
public partial class SnetReports_Default : System.Web.UI.Page
{
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (PerformValidation())
        {
            ...
            SessionVars.SalesAgentId = txtSalesAgentID.Text.Trim();
    ...
    protected void custvSpecific_ServerValidate(object source, ServerValidateEventArgs args)
    {
        ...
        if (!String.IsNullOrEmpty(txtTpvAgentId.Text.Trim()))
            total += tpvAgentId;
        if (!String.IsNullOrEmpty(txtSalesAgentID.Text.Trim()))
            total += salesAgentId;
