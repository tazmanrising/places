(function () {
    ...
    var injectParams = ['$location', 'scriptQuestionService', 'questionService', 'toastr'];

    var scriptQuestionController = function($location, scriptQuestionService, questionService, toastr) {
        ...
        if(typeof vm.StateName ==="undefined") {
            //console.log('vm.StateName',vm.StateName);
            vm.StateName = "AA";
            //console.log('vm.StateName',vm.StateName);
        }
        ...
        vm.selectScriptChange = function(){
            ...
            console.log("vm.StateName ", vm.StateName);
            console.log("vm.StateCode ", vm.StateCode);

            if(typeof vm.SalesChannelId != "undefined") {
                //console.log('statecode', vm.StateCode);
                getScriptQuestions(vm.StateName, vm.SalesChannelId);
            }
