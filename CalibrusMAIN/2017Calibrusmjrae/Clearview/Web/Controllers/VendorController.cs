...
namespace Calibrus.ClearviewPortal.Web.Controllers
{
    ...
    public class VendorController : Controller
    {
        ...
        public ActionResult Edit(int id)
        {
	        ...
	        if (!Calibrus.ClearviewPortal.Business.LoginLogic.IsClientAdmin(SessionVars.UserName) && vm.OfficeList.Any(o => o.Users.Any(x=>x.UserName != vm.LoggedOnUser))) 
			{
				return RedirectToAction("AccessDenied", new { controller = "Error" });
	        }
        ...
        {
			if (!Calibrus.ClearviewPortal.Business.LoginLogic.IsClientAdmin(SessionVars.UserName) && vendor.OfficeList.Any(o => o.Users.Any(x=>x.UserName != SessionVars.UserName)))
			{
				return RedirectToAction("AccessDenied", new { controller = "Error" });
			}
