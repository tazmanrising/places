...
namespace Calibrus.ClearviewPortal.Web
{
    public static class SessionVars
    {
        ...
        private const string KwIsQaAdmin = "isqaadmin";
        ...
        public static bool IsQaAdmin
        {
            get { return HttpContext.Current.Session[KwIsQaAdmin] == null ? false : (bool)HttpContext.Current.Session[KwIsQaAdmin]; }
            set { HttpContext.Current.Session[KwIsQaAdmin] = value; }
        }
